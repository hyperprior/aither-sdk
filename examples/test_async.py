...
def test_non_blocking():
    ...
    aither.init(
        api_key="test_key",
        endpoint="http://localhost:8000",  # Your test server
...
def test_immediate_mode():
    ...
    try:
        ...
        print(f"But you can see it took {elapsed*1000:.2f}ms - proving it tried to make HTTP requests")
